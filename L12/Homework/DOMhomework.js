...
span.innerHTML = 'This app was created by: Jester James A. Cabana';
...
const i = ToDo.prototype.completeToDo = function(){
...
function buildToDo(todo, index) {
  ...
  if(ToDo.complete == true && todo == true){
